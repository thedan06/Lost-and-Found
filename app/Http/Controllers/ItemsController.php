...
class ItemsController extends Controller
{
    ...
    public function getAllIItemCategory(){return DB::select('select * from item_category');}

    public function getReportStatus(){return DB::select('select * from report_status');}

    public function getEvents(){return DB::select('select * from event');}
}
